...
public class FoldersPK implements Serializable {
    ...
    public FoldersPK(String foldername, String projectid) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FoldersPK)) {
            return false;
        }
        FoldersPK other = (FoldersPK) object;
    ...
    public String toString() {
        return "entityModels.FoldersPK[ foldername=" + foldername + ", projectid=" + projectid + " ]";
    }
