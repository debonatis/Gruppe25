...
import com.Gruppe25.session.ApplicationAccessFacade;
...
public class ApplicationAccessController implements Serializable {
    ...
    @EJB
    private com.Gruppe25.session.ApplicationAccessFacade ejbFacade;
    ...
    public ApplicationAccess getSelected() {
        if (current == null) {
            ...
            current.setApplicationAccessPK(new com.Gruppe25.ApplicationAccessPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public ApplicationAccess getApplicationAccess(com.Gruppe25.ApplicationAccessPK id) {
    ...
    public static class ApplicationAccessControllerConverter implements Converter {
        ...
        com.Gruppe25.ApplicationAccessPK getKey(String value) {
            com.Gruppe25.ApplicationAccessPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.Gruppe25.ApplicationAccessPK();
            key.setAppUsername(values[0]);
            key.setUserApplicationName(values[1]);
            return key;
        }

        String getStringKey(com.Gruppe25.ApplicationAccessPK value) {
            StringBuilder sb = new StringBuilder();
            sb.append(value.getAppUsername());
            sb.append(SEPARATOR);
            sb.append(value.getUserApplicationName());
            return sb.toString();
        }
