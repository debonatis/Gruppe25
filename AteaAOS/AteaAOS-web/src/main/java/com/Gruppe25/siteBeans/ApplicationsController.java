...
public class ApplicationsController implements Serializable {
    ...
    @EJB
    private com.Gruppe25.session.ApplicationsFacade ejbFacade;
    ...
    public Applications getApplications(java.lang.String id) {
    ...
    public static class ApplicationsControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getApplications(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Applications) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Applications.class.getName());
            }
        }
