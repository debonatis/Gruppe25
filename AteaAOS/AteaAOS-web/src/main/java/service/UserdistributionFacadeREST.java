 ...
 */
@Stateless
@Path("entitymodels.userdistribution")
public class UserdistributionFacadeREST extends AbstractFacade<Userdistribution> {
    ...
    private UserdistributionPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        entityModels.UserdistributionPK key = new entityModels.UserdistributionPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        entityModels.UserdistributionPK key = getPrimaryKey(id);
