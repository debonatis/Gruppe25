...
import entityModels.Grouplevel1PK;
...
public class Grouplevel1FacadeREST extends AbstractFacade<Grouplevel1> {
    ...
    private Grouplevel1PK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        entityModels.Grouplevel1PK key = new entityModels.Grouplevel1PK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        entityModels.Grouplevel1PK key = getPrimaryKey(id);
