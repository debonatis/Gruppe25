...
import entityModels.GroupaffiliationsPK;
 ...
 */
@Stateless
@Path("entitymodels.groupaffiliations")
public class GroupaffiliationsFacadeREST extends AbstractFacade<Groupaffiliations> {
    ...
    private GroupaffiliationsPK getPrimaryKey(PathSegment pathSegment) {
         ...
         */
        entityModels.GroupaffiliationsPK key = new entityModels.GroupaffiliationsPK();
    ...
    public void remove(@PathParam("id") PathSegment id) {
        entityModels.GroupaffiliationsPK key = getPrimaryKey(id);
