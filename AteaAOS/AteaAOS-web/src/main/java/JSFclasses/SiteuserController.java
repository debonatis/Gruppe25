...
import SessionBeans.SiteuserFacade;
...
public class SiteuserController implements Serializable {
    ...
    @EJB
    private SessionBeans.SiteuserFacade ejbFacade;
    ...
    public Siteuser getSiteuser(java.lang.String id) {
    ...
    public static class SiteuserControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getSiteuser(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Siteuser) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + Siteuser.class.getName());
            }
        }
