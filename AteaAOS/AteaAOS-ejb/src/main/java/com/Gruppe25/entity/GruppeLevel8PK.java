 ...
 */
@Embeddable
public class GruppeLevel8PK implements Serializable {
    ...
    public GruppeLevel8PK() {
    }

    public GruppeLevel8PK(String guID, String groupName) {
        this.guID = guID;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GruppeLevel8PK)) {
            return false;
        }
        GruppeLevel8PK other = (GruppeLevel8PK) object;
    ...
    public String toString() {
        return "com.Gruppe25.entity.GruppeLevel8PK[ guID=" + guID + ", groupName=" + groupName + " ]";
    }
