 ...
 */
@Embeddable
public class GruppeLevel7PK implements Serializable {
    ...
    public GruppeLevel7PK() {
    }

    public GruppeLevel7PK(String guID, String groupName) {
        this.guID = guID;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GruppeLevel7PK)) {
            return false;
        }
        GruppeLevel7PK other = (GruppeLevel7PK) object;
    ...
    public String toString() {
        return "com.Gruppe25.entity.GruppeLevel7PK[ guID=" + guID + ", groupName=" + groupName + " ]";
    }
