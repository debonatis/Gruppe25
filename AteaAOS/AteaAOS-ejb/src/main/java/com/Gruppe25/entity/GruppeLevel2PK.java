 ...
 */
@Embeddable
public class GruppeLevel2PK implements Serializable {
    ...
    public GruppeLevel2PK() {
    }

    public GruppeLevel2PK(String guID, String groupName) {
        this.guID = guID;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GruppeLevel2PK)) {
            return false;
        }
        GruppeLevel2PK other = (GruppeLevel2PK) object;
    ...
    public String toString() {
        return "com.Gruppe25.entity.GruppeLevel2PK[ guID=" + guID + ", groupName=" + groupName + " ]";
    }
