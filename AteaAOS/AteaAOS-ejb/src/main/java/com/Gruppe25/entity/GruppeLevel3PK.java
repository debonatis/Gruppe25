 ...
 */
@Embeddable
public class GruppeLevel3PK implements Serializable {
    ...
    public GruppeLevel3PK() {
    }

    public GruppeLevel3PK(String guID, String groupName) {
        this.guID = guID;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GruppeLevel3PK)) {
            return false;
        }
        GruppeLevel3PK other = (GruppeLevel3PK) object;
    ...
    public String toString() {
        return "com.Gruppe25.entity.GruppeLevel3PK[ guID=" + guID + ", groupName=" + groupName + " ]";
    }
