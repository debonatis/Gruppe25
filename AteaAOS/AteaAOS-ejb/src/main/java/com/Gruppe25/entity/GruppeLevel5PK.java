 ...
 */
@Embeddable
public class GruppeLevel5PK implements Serializable {
    ...
    public GruppeLevel5PK() {
    }

    public GruppeLevel5PK(String guID, String groupName) {
        this.guID = guID;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GruppeLevel5PK)) {
            return false;
        }
        GruppeLevel5PK other = (GruppeLevel5PK) object;
    ...
    public String toString() {
        return "com.Gruppe25.entity.GruppeLevel5PK[ guID=" + guID + ", groupName=" + groupName + " ]";
    }
