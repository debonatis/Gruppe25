 ...
 */
@Embeddable
public class GruppeLevel1PK implements Serializable {
    ...
    public GruppeLevel1PK() {
    }

    public GruppeLevel1PK(String guID, String groupName) {
        this.guID = guID;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GruppeLevel1PK)) {
            return false;
        }
        GruppeLevel1PK other = (GruppeLevel1PK) object;
    ...
    public String toString() {
        return "com.Gruppe25.entity.GruppeLevel1PK[ guID=" + guID + ", groupName=" + groupName + " ]";
    }
