 ...
 */
@Embeddable
public class GruppeLevel4PK implements Serializable {
    ...
    public GruppeLevel4PK() {
    }

    public GruppeLevel4PK(String guID, String groupName) {
        this.guID = guID;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof GruppeLevel4PK)) {
            return false;
        }
        GruppeLevel4PK other = (GruppeLevel4PK) object;
    ...
    public String toString() {
        return "com.Gruppe25.entity.GruppeLevel4PK[ guID=" + guID + ", groupName=" + groupName + " ]";
    }
